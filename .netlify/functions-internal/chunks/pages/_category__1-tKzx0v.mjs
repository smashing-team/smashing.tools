import { A as AstroError, e as UnknownContentCollectionError, f as createComponent, r as renderUniqueStylesheet, g as renderScriptElement, h as createHeadAndContent, i as renderTemplate, j as renderComponent, u as unescapeHTML, k as createAstro, m as maybeRenderHead, l as addAttribute, n as renderTransition, o as renderHead, p as createTransitionScope, q as renderSlot } from '../astro_9ur4oi-I.mjs';
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/code/shipfast.mdx": () => import('../shipfast_rLv1J31r.mjs'),"/src/content/design/untitledui.mdx": () => import('../untitledui__dsmCcJ8.mjs')});
...
const $$category = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AppLayout", $$AppLayout, { "title": SITE_TITLE, "description": SITE_DESCRIPTION }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "data-astro-transition-persist": createTransitionScope($$result2, "wnpfhhlf") })} ${maybeRenderHead()}<pre>${JSON.stringify(Astro2.params)}</pre> <pre>${JSON.stringify(Astro2.props)}</pre> ${renderComponent($$result2, "GridList", $$GridList, { "items": items })} ` })}`;
}, "/Users/needim/projects/smashing-team/smashing.tools/src/pages/category/[category].astro", "self");

const $$file = "/Users/needim/projects/smashing-team/smashing.tools/src/pages/category/[category].astro";
...
export { $$Header as $, SITE_TITLE as S, _category_ as _, $$GridList as a, SITE_DESCRIPTION as b, $$AppLayout as c, getCollection as g };
